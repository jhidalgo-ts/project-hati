...
<div class="perfil-box login-box-body">
    <h3 class="login-box-msg">Perfil del Usuario</h3>
    <div class="row">
        <div class="col-lg-4">
        ...
        <div class="col-lg-8">
            <?= $form->field($user, 'username')->textInput(['placeholder' => 'Usuario', 'disabled' => 'true'])?>
            <?= $form->field($user, 'email')->textInput(['placeholder' => 'Email', 'disabled' => 'true'])?>
